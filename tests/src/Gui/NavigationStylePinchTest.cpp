...
TEST(NavigationStylePinchAction, aNativeGestureRotatesEvenWhenTouchTiltIsDisabled)
{
...
TEST(NavigationStylePinchAction, aNativeRotateOnlyEventIsNotBlockedByTheTiltPreference)
{
    const auto event = updateEvent(0.0, 0.5, true);
